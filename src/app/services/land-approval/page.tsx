...
import LandApprovalSection from './components/LandApprovalSection';
...
export default function LandApprovalPage() {
    ...
    <div className="w-full min-h-screen bg-brand-gray-light flex flex-col relative overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-[0.05] pointer-events-none z-0">
        <svg viewBox="0 0 100 100" className="h-full w-full stroke-brand-gold/35 fill-none stroke-[0.06]">
          <pattern id="land-approval-hexes" x="0" y="0" width="10" height="17.3" patternUnits="userSpaceOnUse">
            <path d="M5 0 L10 2.8 L10 8.5 L5 11.3 L0 8.5 L0 2.8 Z" />
          </pattern>
          <rect width="100%" height="100%" fill="url(#land-approval-hexes)" />
        </svg>
      </div>
