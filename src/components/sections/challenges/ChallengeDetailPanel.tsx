    ...
    return (
      <div className="h-full flex flex-col items-center justify-center text-center p-8 border border-dashed border-[#0C2C4D]/10 rounded-2xl bg-[#0C2C4D]/[0.01]">
        <div className="w-16 h-16 rounded-full bg-[#0C2C4D]/[0.03] border border-[#0C2C4D]/5 flex items-center justify-center mb-4">
          <Compass className="w-8 h-8 text-[#0C2C4D]/40 stroke-1" />
        </div>
        <h4 className="text-sm font-tibere font-bold tracking-wider text-[#0C2C4D] uppercase">
          No Node Selected
        </h4>
      ...
      <div>
        <div className="flex items-start justify-between relative z-10 mb-6">
          <div className="flex items-center space-x-4">
            <span className="text-5xl font-mono font-bold text-[#BFA052] leading-none">
              {challenge.number}
            </span>
        ...
        <div className="relative z-10 mb-6">
          <h3 className="text-2xl font-tibere font-bold text-[#0C2C4D] tracking-wide mb-3">
            {challenge.title}
          </h3>
          <p className="text-xs font-gotham text-slate-600 leading-relaxed font-normal">
            {challenge.longDesc}
          </p>
        </div>
        ...
        <div className="relative z-10 p-5 bg-gradient-to-br from-[#0C2C4D]/[0.02] to-[#0C2C4D]/[0.05] border-l-2 border-[#BFA052] rounded-r-xl mb-6">
          <div className="flex items-center space-x-2 text-[#0C2C4D] mb-2">
            ...
            <h4 className="text-sm font-tibere font-bold tracking-wide">
