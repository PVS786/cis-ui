...
const outputPath = "C:\\Users\\Bala\\Downloads\\webUI\\cis-ui\\.antigravity\\scratch\\step_294_onwards_diffs.txt";
...
rl.on('close', () => {
  outStream.end();
  console.log("Done writing to step_294_onwards_diffs.txt");
});
